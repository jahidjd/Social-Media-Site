    ...
    <div class="row">
      <div class="col-sm-5">
        <div class="intro-texts">
          ...
          <p>Friend Finder is a social network template that can be used to connect people. The template offers Landing
            pages, News Feed, Image/Video Feed, Chat Box, Timeline and lot more. <br /> <br />Why are you waiting for?
            Buy it now.</p>
        ...
        <div class="reg-form-container">
          ...
          <div class="tab-content">
            <div class="tab-pane " id="register">
              ...
              <form action="{{route('signup')}}" name="registration_form" id='registration_form' class="form-inline"
                method="post">
                @csrf
                <div class="row">
                  <div class="form-group col-xs-6">
                    <label for="firstname" class="sr-only">First Name</label>
                    <input id="firstname" class="form-control input-group-lg" type="text" name="first_name"
                      title="Enter first name" placeholder="First name" />
                  </div>
                  <div class="form-group col-xs-6">
                    <label for="lastname" class="sr-only">Last Name</label>
                    <input id="lastname" class="form-control input-group-lg" type="text" name="last_name"
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-12 col-xs-12">
                    <input id="birth" class="form-control input-group-lg" type="date" name="date_of_birth" />
            ...
            <div class="tab-pane active" id="login">
              ...
              <!--Login Form-->
              <form name="Login_form" id='Login_form' action="{{route('signin')}}" method="post">
                @csrf
                <div class="row">
                  <div class="form-group col-xs-12">
                    <label for="my-email" class="sr-only">Email</label>
                    <input id="my-email" class="form-control input-group-lg" type="text" name="email"
                ...
                <div class="row">
                  <div class="form-group col-xs-12">
                    ...
                    <input id="my-password" class="form-control input-group-lg" type="password" name="password"
                      title="Enter password" placeholder="Password" />
                  </div>
                </div>
